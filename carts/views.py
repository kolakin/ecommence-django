...
def _cart_id(request): # using the "_" to create a private function
...
def add_cart(request, product_id):
    ...
    if is_cart_item_exit:
        ...
        #   current existing variation and product variation
        #  item id
        ext_var_list = []
        id = []
...
def cart(request, total=0, quantity=0, cart_items=None):
    ...
    except CartItem.DoesNotExist and Cart.DoesNotExist:
        pass
